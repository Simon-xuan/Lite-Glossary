...
// 定义插件常量
define( 'LITE_GLOSSARY_VERSION', '1.0.2' );
define( 'LITE_GLOSSARY_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );
define( 'LITE_GLOSSARY_PLUGIN_URL', plugin_dir_url( __FILE__ ) );

// 加载多语言翻译（默认简体中文，站点语言设为 English 时自动显示英文）
function lite_glossary_load_textdomain() {
    load_plugin_textdomain( 'lite-glossary', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
}
add_action( 'init', 'lite_glossary_load_textdomain' );
